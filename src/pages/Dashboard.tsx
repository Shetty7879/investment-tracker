...
export const Dashboard: React.FC = () => {
  ...
  // Active Holdings Count using authoritative calculateActiveHoldings helper
  const activeHoldingsCount = useMemo(() => {
    return calculateActiveHoldings(holdings, allTransactions, marketPrices);
  ...
  return (
    <div className="space-y-6 animate-slide-in pb-8 font-sans font-medium text-xs text-slate-700 dark:text-slate-350">

      {/* Portfolio Overview Section Header */}
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h2 className="font-display text-xl font-bold tracking-tight text-slate-900 dark:text-white m-0">Portfolio Overview</h2>
          <p className="font-sans text-sm text-slate-405 dark:text-slate-500 m-0 font-medium">
        ...
        <div className="flex flex-wrap items-center gap-3">
          <button
            ...
            className="flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-indigo-650 hover:bg-indigo-700 text-white font-sans font-semibold text-sm shadow-sm hover:shadow transition-all cursor-pointer whitespace-nowrap active:scale-95"
          >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white dark:bg-[#0d0f17] border border-slate-200/80 dark:border-slate-800/60 rounded-2xl p-6 shadow-sm flex flex-col justify-between min-h-[180px] hover:border-indigo-500/30 dark:hover:border-indigo-500/30 hover:shadow-md transition-all duration-300 group cursor-default animate-fade-in animate-duration-300">
          <div className="w-full flex flex-col justify-between h-full gap-y-5">
            <div className="flex items-center justify-between text-slate-500 dark:text-slate-400 text-xs font-sans font-semibold uppercase tracking-wider">
              <span className="font-display font-semibold text-[11px]">TOTAL AMOUNT INVESTED</span>
            ...
            <div>
              <div className="font-display tabular-nums text-2xl md:text-3xl font-extrabold text-[#10b981] dark:text-[#36E6B4] [text-shadow:0_0_14px_rgba(54,230,180,0.25)] leading-none tracking-tight">
                {formatCurrency(totalInvestedAmount)}
              </div>
              <div className="font-sans text-xs text-slate-500 dark:text-slate-405/90 font-medium mt-2">
        ...
        {/* Active Investments */}
        <div className="bg-white dark:bg-[#0d0f17] border border-slate-200/80 dark:border-slate-800/60 rounded-2xl p-6 shadow-sm flex flex-col justify-between min-h-[180px] hover:border-indigo-500/30 dark:hover:border-indigo-500/30 hover:shadow-md transition-all duration-300 group cursor-default">
          <div className="w-full flex flex-col justify-between h-full gap-y-5">
            <div className="flex items-center justify-between text-slate-500 dark:text-slate-400 text-xs font-sans font-semibold uppercase tracking-wider">
              <span className="font-display font-semibold text-[11px]">📦 ACTIVE INVESTMENTS</span>
              <div className="p-2 rounded-xl bg-slate-50 dark:bg-slate-900/60 border border-slate-100 dark:border-slate-800/40 group-hover:border-indigo-500/20 group-hover:bg-indigo-50 dark:group-hover:bg-indigo-950/20 group-hover:text-indigo-500 transition-all flex-shrink-0">
                <ArrowUpRight className="h-4 w-4 text-slate-500 dark:text-slate-400 group-hover:text-indigo-500 transition-colors" />
              </div>
            </div>
            <div>
              <div className="font-display tabular-nums text-2xl md:text-3xl font-extrabold text-[#f59e0b] dark:text-[#FFC94A] [text-shadow:0_0_14px_rgba(255,201,74,0.25)] leading-none tracking-tight">
                {numberOfInvestments}
              </div>
              <div className="font-sans text-xs text-slate-500 dark:text-slate-405/90 font-medium mt-2">
                Investment records
        ...
        <div className="bg-white dark:bg-[#0d0f17] border border-slate-200/80 dark:border-slate-800/60 rounded-2xl p-6 shadow-sm flex flex-col justify-between min-h-[180px] hover:border-indigo-500/30 dark:hover:border-indigo-500/30 hover:shadow-md transition-all duration-300 group cursor-default">
          <div className="w-full flex flex-col justify-between h-full gap-y-5">
            <div className="flex items-center justify-between text-slate-500 dark:text-slate-400 text-xs font-sans font-semibold uppercase tracking-wider">
              <span className="font-display font-semibold text-[11px]">💼 ACTIVE HOLDINGS</span>
              <div className="p-2 rounded-xl bg-slate-50 dark:bg-slate-900/60 border border-slate-100 dark:border-slate-800/40 group-hover:border-indigo-500/20 group-hover:bg-indigo-50 dark:group-hover:bg-indigo-950/20 group-hover:text-indigo-500 transition-all flex-shrink-0">
                <ArrowUpRight className="h-4 w-4 text-slate-500 dark:text-slate-400 group-hover:text-indigo-500 transition-colors" />
              </div>
            </div>
            <div>
              <div className="font-display tabular-nums text-2xl md:text-3xl font-extrabold text-[#0ea5e9] dark:text-[#5CC8FF] [text-shadow:0_0_14px_rgba(92,200,255,0.25)] leading-none tracking-tight">
                {activeHoldingsCount}
              </div>
              <div className="font-sans text-xs text-slate-500 dark:text-slate-405/90 font-medium mt-2">
        ...
        <div className="bg-white dark:bg-[#0d0f17] border border-slate-200/80 dark:border-slate-800/60 rounded-2xl p-6 shadow-sm flex flex-col justify-between min-h-[180px] hover:border-indigo-500/30 dark:hover:border-indigo-500/30 hover:shadow-md transition-all duration-300 group cursor-default animate-fade-in animate-duration-300">
          <div className="w-full flex flex-col justify-between h-full gap-y-5">
            <div className="flex items-center justify-between text-slate-500 dark:text-slate-400 text-xs font-sans font-semibold uppercase tracking-wider">
              <span className="font-display font-semibold text-[11px]">📅 MONTHLY INVESTED</span>
              <div className="p-2 rounded-xl bg-slate-50 dark:bg-slate-900/60 border border-slate-100 dark:border-slate-800/40 group-hover:border-indigo-500/20 group-hover:bg-indigo-50 dark:group-hover:bg-indigo-950/20 group-hover:text-indigo-500 transition-all flex-shrink-0">
                <Calendar className="h-4 w-4 text-slate-500 dark:text-slate-400 group-hover:text-indigo-500 transition-colors" />
              </div>
            </div>
            <div>
              <div className="font-display tabular-nums text-2xl md:text-3xl font-extrabold text-[#8b5cf6] dark:text-[#B77CFF] [text-shadow:0_0_14px_rgba(183,124,255,0.25)] leading-none tracking-tight">
      ...
      <div className="bg-white dark:bg-[#0d0f17] border border-slate-200 dark:border-slate-855 rounded-2xl p-6 shadow-sm">
        <div className="flex items-center justify-between mb-4 border-b border-slate-100 dark:border-slate-855 pb-2">
          <div>
            <h3 className="font-display text-sm font-semibold text-slate-900 dark:text-white m-0">
              📋 Recent Investments
            </h3>
            <p className="font-sans text-xs text-slate-400 dark:text-slate-555 mt-0.5 mb-0 font-medium">
          ...
          {numberOfInvestments > 0 && (
            <button
              ...
              className="font-sans text-xs font-semibold text-indigo-650 dark:text-indigo-400 hover:text-indigo-700 hover:underline cursor-pointer"
            >
              View All
            </button>
          )}
        ...
        {recentInvestments.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <h4 className="font-display text-sm font-semibold text-slate-900 dark:text-white mb-1">No investments yet</h4>
            <p className="font-sans text-xs text-slate-405 dark:text-slate-500 max-w-xs mb-4 font-medium">
              Start tracking your investments by adding your first investment.
            </p>
            <button
              onClick={() => setIsAssetModalOpen(true)}
              className="flex items-center justify-center gap-1.5 px-4 py-2 rounded-xl bg-indigo-650 hover:bg-indigo-700 text-white font-sans font-semibold text-sm shadow-md shadow-indigo-600/10 cursor-pointer active:scale-95"
            >
          ...
          <>
            ...
            <div className="hidden md:block overflow-x-auto w-full">
              <table className="w-full border-collapse text-left text-xs font-sans font-medium">
                <thead className="bg-slate-50/50 dark:bg-slate-900/40 text-slate-450 dark:text-slate-500 text-[10px] font-sans font-semibold uppercase tracking-wider border-b border-slate-150 dark:border-slate-855">
                  <tr>
                ...
                <tbody className="divide-y divide-slate-150 dark:divide-slate-850 font-sans font-medium">
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-4 py-3.5 whitespace-nowrap">
                          <span className={`px-2.5 py-0.5 rounded-full text-[10px] font-sans font-semibold ${getAssetTypeBadgeStyle(displayType)}`}>
                            {displayType}
                          </span>
                        </td>
                        <td className="px-4 py-3.5 whitespace-nowrap">
                          <span className={`px-2.5 py-0.5 rounded-full text-[10px] font-sans font-semibold ${getBrokerBadgeStyle(broker)}`}>
                            {broker}
                          </span>
                        </td>
                        <td className="px-4 py-3.5 text-right text-slate-700 dark:text-slate-350 whitespace-nowrap font-sans font-medium">
                          {isCommodityCategory(inv.category || inv.assetType) ? `${inv.weightGrams ?? inv.quantity} ${inv.weightUnit || 'g'}` : inv.quantity}
                        </td>
                        <td className="px-4 py-3.5 text-right font-display font-bold text-indigo-650 dark:text-indigo-400 whitespace-nowrap">
                          {formatCurrency(inv.investedAmount)}
                        </td>
                        <td className="px-4 py-3.5 text-center text-[11px] font-sans font-medium text-slate-500 dark:text-slate-400 whitespace-nowrap">
            ...
            <div className="md:hidden space-y-4 font-sans font-medium">
              {recentInvestments.map(inv => {
                const displayType = REVERSE_TYPE_MAPPING[inv.category] || REVERSE_TYPE_MAPPING[inv.assetType] || 'Other';
                const broker = inv.broker === 'Other' && inv.customBroker ? inv.customBroker : (inv.broker || 'Other');
                const status = getInvestmentStatus(inv);
                return (
                  ...
                  >
                    <div className="flex justify-between items-start">
                      ...
                      <div className="flex items-center gap-1.5">
                        {renderStatusBadge(status)}
                        <span className={`px-2 py-0.5 rounded-full text-[9px] font-sans font-semibold ${getAssetTypeBadgeStyle(displayType)}`}>
                          {displayType}
                        </span>
                      </div>
                    </div>
                    <div className="grid grid-cols-3 gap-2 pt-2 border-t border-slate-105 dark:border-slate-800 text-[10px]">
                      <div>
                        <span className="block text-[8px] uppercase tracking-wider text-slate-450 mb-0.5 font-sans font-medium">Platform</span>
                        <span className="font-sans font-semibold text-slate-850 dark:text-slate-200">{broker}</span>
                      </div>
                      <div>
                        <span className="block text-[8px] uppercase tracking-wider text-slate-450 mb-0.5 font-sans font-medium">
                          {isCommodityCategory(inv.category || inv.assetType) ? 'Weight' : 'Quantity'}
                        </span>
                        <span className="font-sans font-semibold text-slate-855 dark:text-slate-200">
                          {isCommodityCategory(inv.category || inv.assetType) ? `${inv.weightGrams ?? inv.quantity} ${inv.weightUnit || 'g'}` : inv.quantity}
                        </span>
                      </div>
                      <div>
                        <span className="block text-[8px] uppercase tracking-wider text-slate-450 mb-0.5 font-sans font-medium">Invested</span>
                        <span className="font-display font-bold text-indigo-650 dark:text-indigo-400">{formatCurrency(inv.investedAmount)}</span>
                      </div>
                    </div>
                  </div>
                );
      ...
      <div className="bg-white dark:bg-[#0d0f17] border border-slate-200 dark:border-slate-855 rounded-2xl p-6 shadow-sm hover:shadow-md hover:border-slate-300 dark:hover:border-slate-800 transition-all duration-300">
        <div className="flex items-center justify-between mb-4 border-b border-slate-100 dark:border-slate-855 pb-2">
          ...
          <button
            ...
            className="flex items-center gap-1 px-3 py-1.5 text-[10px] font-sans font-semibold text-indigo-650 dark:text-indigo-400 bg-indigo-500/5 hover:bg-indigo-500/10 border border-indigo-500/10 hover:border-indigo-500/20 rounded-lg transition-all cursor-pointer whitespace-nowrap active:scale-95"
          >
            View Money Tracker →
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="bg-slate-50/50 dark:bg-slate-900/10 border border-slate-150 dark:border-slate-855 rounded-xl p-4 flex items-center justify-between">
            <div>
              <span className="block text-[10px] font-sans font-semibold text-slate-400 dark:text-slate-500 uppercase tracking-wider mb-1">💰 To Receive</span>
              <span className="font-display text-xl font-bold text-slate-900 dark:text-white block">
          ...
          <div className="bg-slate-50/50 dark:bg-slate-900/10 border border-slate-150 dark:border-slate-855 rounded-xl p-4 flex items-center justify-between">
            <div>
              <span className="block text-[10px] font-sans font-semibold text-slate-400 dark:text-slate-500 uppercase tracking-wider mb-1">💸 To Give</span>
              <span className="font-display text-xl font-bold text-slate-900 dark:text-white block">
      ...
      <div className="bg-white dark:bg-[#0d0f17] border border-slate-200 dark:border-slate-855 rounded-2xl p-6 shadow-sm hover:shadow-md hover:border-slate-300 dark:hover:border-slate-800 transition-all duration-300">
        ...
        {platformInvestments.length === 0 ? (
          <div className="text-center py-6 text-slate-405 dark:text-slate-500 text-xs font-sans font-medium">
              ...
              return (
                <div key={platform.name} className="space-y-1.5">
                  <div className="flex justify-between items-center text-xs">
                    <span className="font-sans font-medium text-slate-700 dark:text-slate-300 break-words max-w-[70%]">
                      {platform.name}
                    </span>
                    <span className="font-display font-bold text-slate-900 dark:text-white whitespace-nowrap">
